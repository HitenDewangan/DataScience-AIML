...
CREATE TABLE `employee_assignment` (
  `Employee_EmployeeID` int(11) NOT NULL DEFAULT '0',
  `Assignment_Assignment_ID` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`Employee_EmployeeID`,`Assignment_Assignment_ID`),
  KEY `Assignment_Assignment_ID` (`Assignment_Assignment_ID`),
  CONSTRAINT `employee_assignment_ibfk_1` FOREIGN KEY (`Employee_EmployeeID`) REFERENCES `employee` (`EmployeeID`),
  CONSTRAINT `employee_assignment_ibfk_2` FOREIGN KEY (`Assignment_Assignment_ID`) REFERENCES `assignment` (`Assignment_ID`)
